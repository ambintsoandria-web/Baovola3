...
public interface AbsenceRepository extends JpaRepository<Absence, Long> {
  ...
  /**
   * Nombre d'absences (justifiées + non justifiées, hors simples retards) par
   * étudiant
  ...
  @Query("SELECT a FROM Absence a WHERE a.etudiantId = :id_etudiant")
  List<Absence> listeAbsencesEtudiant(@Param("id_etudiant") Integer id_etudiant);
}
