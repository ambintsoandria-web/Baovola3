...
public class Periode {
    ...
    public LocalDate getDatePublicationNotes() { return datePublicationNotes; }
    public void setDatePublicationNotes(LocalDate datePublicationNotes) { this.datePublicationNotes = datePublicationNotes; }
    public Boolean getEstCloturee() { return estCloturee; }
