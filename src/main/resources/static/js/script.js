...
const pagePaths = {
  // Directeur
  'dir-dashboard': '/directeur/dashboard',
  'dir-finances': '/directeur/finances',
  'dir-professeurs': '/directeur/professeurs',
  'dir-prof-profil': '/directeur/profil-professeur',
  'dir-ecolages': '/directeur/ecolages',
  // Secretariat
  'sec-paiements': '/secretaire/paiements',
  'sec-bilan': '/secretaire/bilan',
  'sec-eleves': '/secretaire/eleves',
  'sec-profils': '/secretaire/profil-eleve',
  // Professeur
  'prof-emploi': '/professeur/emploi',
  'prof-notes': '/professeur/notes',
  'prof-devoirs': '/professeur/devoirs',
  'prof-bulletins': '/professeur/bulletins',
  'prof-profil': '/professeur/profil',
  // Etudiant
  'etu-emploi': '/etudiant/emploi',
  'etu-notes': '/etudiant/notes',
  'etu-bulletin': '/etudiant/bulletin',
  'etu-devoirs': '/etudiant/devoirs',
  // Communs
...
window.addEventListener('DOMContentLoaded', () => {
  // On récupère le rôle sélectionné dans le <select> du HTML
  const roleSelect = document.getElementById('roleSelect');
  if (roleSelect) {
    const currentRole = roleSelect.value;
    const defaultPage = roles[currentRole]?.defaultPage || 'etu-emploi';

    // On ne charge la page que si le contenu principal est vide ou pour initialiser
